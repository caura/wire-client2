...
#General terms
z.string.wire = 'Caura Consulting'
...
z.string.auth_posted_offline_headline = 'Caura Chat Client is nicer online.'
...
# z.string.conversation_create_you = ' welcomes you'
...
# z.string.conversation_member_join = ' added new Guests'
z.string.conversation_member_join_you = ' added %@names'
# z.string.conversation_member_join_you = ' added new Guests'
...
z.string.conversation_resume = 'Welcomes you!'
