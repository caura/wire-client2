...
# Authentication: limit section
z.string.auth_history_headline = 'It’s the first time you’re using Caura\'sWire on this device.'
z.string.auth_history_description = 'For privacy reasons, your conversation history will not appear here.'
z.string.auth_history_reuse_headline = 'You’ve used Caura\'s Wire on this device before.'
...
z.string.creds_taken = 'Busy signal... Please send us an email: hello@caura.co'
...
# App loading
z.string.init_pre_auth = 'Scaling Computing Resources'
...
z.string.init_sessions_expectation = 'In Progress...'
z.string.init_sessions_expectation_long = 'In Progress...'
z.string.init_sessions_progress = 'Initializing - %progress of %total'
z.string.init_initialized_storage = 'Loaded'
z.string.init_initialized_cryptography = 'Cryptography has been fully set up'
z.string.init_validated_client = 'Loading Web Client'
z.string.init_received_user_data = 'Checking for new messages'
z.string.init_events_expectation = 'You have %events new messages'
z.string.init_events_expectation_long = 'Loading'
z.string.init_events_progress = 'Loading...'
z.string.init_updated_from_notifications = 'We are almost there'
z.string.init_app_pre_loaded = 'Enjoy Caura (powered by Wire)'
