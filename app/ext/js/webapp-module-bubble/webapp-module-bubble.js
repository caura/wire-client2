...
(function() {
  ...
  zeta.webapp.module.Bubble = (function() {
    function Bubble(options) {
      ...
      this.on_window_resize = __bind(this.on_window_resize, this);
      this.on_window_click = __bind(this.on_window_click, this);
    ...
    Bubble.prototype.init = function() {
      ...
      if ((_ref = this.placement) === 'top' || _ref === 'vertical') {
    ...
    Bubble.prototype.recalculate = function() {
      var bubble_height, bubble_width, distance_from_top, host_bottom, host_height, host_left, host_midpoint, host_right, host_top, host_width, parent_offset, position, window_height, _ref;
      position = (_ref = this.host.get(0)) != null ? _ref.getBoundingClientRect() : void 0;
    ...
    Bubble.prototype.show = function() {
      ...
      this.observer.observe(this.bubble[0], {
        childList: true,
        subtree: true
      });
      if (!this.host.parent()[0]) {
        return;
      }
      return this.host_observer.observe(this.host.parent()[0], {
        childList: true,
        subtree: true
      });
    };
    ...
    Bubble.prototype.hide = function() {
      ...
      return this.bubble.off('transitionend').removeClass('bubble-animation-show').one('transitionend', (function(_this) {
        return function() {
